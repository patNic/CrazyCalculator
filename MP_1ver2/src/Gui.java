...
public class Gui extends JPanel {
	...
	public JLabel number = new JLabel("Message");
	public JLabel operator = new JLabel("Parsed");
	public JLabel[] snapTitle = new JLabel[4];
	public String[] snapString = {"STACK", "QUEUE", "PSEUDOARRAY", "Linked List"};
	public static JTextArea[] table = new JTextArea[4];
	public static JTextArea[] stat = new JTextArea[4];
	public String input = "";
	...
	public Gui(){
		...
		bgPanel.setPreferredSize(new Dimension(1300,600));
		...
		snapShot.setBounds(600, 20, 675, 520);
		...
		for(int a = 0;a<4;a++){
			stat[a] = new JTextArea(50,2);
			stat[a].setPreferredSize(new Dimension(80, 20));
			stat[a].setEditable(false);
			stat[a].setLineWrap(true);
			stat[a].setFont(new Font("Serif", Font.PLAIN, 15));
		}
		
		snapShot.setLayout(null);
		
		number.setFont(new Font("Impact", Font.ITALIC, 20));
		number.setForeground(new Color(255,255,255));
		number.setBounds(23,90,90,35);
		snapShot.add(number);
		
		operator.setFont(new Font("Impact", Font.ITALIC, 20));
		operator.setForeground(new Color(255,255,255));
		operator.setBounds(23,270,90,35);
		snapShot.add(operator);
		
		stat[0].setBounds(13, 130, 230, 65);
		snapShot.add(stat[0]);
		
		stat[1].setBounds(13, 200, 230, 65);
		snapShot.add(stat[1]);
		
		stat[3].setBounds(13, 300, 230, 65);
		snapShot.add(stat[3]);

		snapTitle[0].setBounds(277,20,100,20);
		snapShot.add(snapTitle[0]);
		
		snapTitle[1].setBounds(380,20,100,20);
		snapShot.add(snapTitle[1]);
		
		snapTitle[2].setBounds(460,20,100,20);
		snapShot.add(snapTitle[2]);
		
		snapTitle[3].setBounds(570,20,200,20);
		snapShot.add(snapTitle[3]);
		
		for(int b = 0;b<4;b++){
			table[b] = new JTextArea(100,100);
			table[b].setPreferredSize(new Dimension(50, 450));
		...
		scroll[0].setBounds(260, 45, 90, 450);
		snapShot.add(scroll[0]);
		
		scroll[1].setBounds(360, 45, 90, 450);
		snapShot.add(scroll[1]);
		
		scroll[2].setBounds(460, 45, 90, 450);
		snapShot.add(scroll[2]);
		
		scroll[3].setBounds(560, 45, 90, 450);
		...
		refreshButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				if(!input.equals("")){
					...
					InfixToPostFixs.strs= new PseudoArray(100);
