...
public class Gui extends JPanel {
	...
	public JTextArea[] textArea = new JTextArea[3];
	...
	public String[] snapString = {"STACK", "QUEUE", "PSEUDOARRAY", "LINKEDLIST"};
	...
	public Gui(){
		...
		bgPanel = new JPanel();
		bgPanel.setBackground(new Color(69, 198, 220));
		...
		operationsIcon[6] = new ImageIcon("src/images/C.png");
		operations[6] = new JButton(operationsIcon[6]);
		operations[6].setBounds(395,440,60,60);
		operations[6].addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				if(!input.equals("")){
					...
					textArea[0].setText("CLEAR OPERATION UNAVAILABLE! INPUT EXPRESSION FIRST.");
				}
			}
		});
		...
		dot.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				if(isRefreshed){
					...
					input = "Reset your expression by clicking the reset button. Thank you!";
					textArea[0].setText(input);
				}
			}
		});
		...
		for(int a = 0;a<4;a++){
			...
			snapTitle[a].setFont(new Font("Impact", Font.ITALIC, 25));
		...
		snapTitle[0].setBounds(40,10,100,20);
		snapShot.add(snapTitle[0]);
		
		snapTitle[1].setBounds(180,10,100,20);
		snapShot.add(snapTitle[1]);
		
		snapTitle[2].setBounds(270,10,200,20);
		snapShot.add(snapTitle[2]);
		
		snapTitle[3].setBounds(420,10,200,20);
		snapShot.add(snapTitle[3]);
		
		for(int b = 0;b<4;b++){
			table[b] = new JTextArea(15,15);
			table[b].setPreferredSize(new Dimension(100, 450));
			...
			//table[b].setBackground(new Color(187, 247, 188));
		}
		
		
		table[0].setBounds(30, 40, 100, 450);
		snapShot.add(table[0]);
		
		table[1].setBounds(165, 40, 100, 450);
		snapShot.add(table[1]);
		
		table[2].setBounds(295, 40, 100, 450);
		snapShot.add(table[2]);
		
		table[3].setBounds(425, 40, 100, 450);
		snapShot.add(table[3]);
		...
		enter.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				if(valid){
					...
					textArea[2].setText(""+output1);
					//table[0].setText(theTrans.forSnapShot);
					table[1].setText(theTrans.forSnapShot);
					table[2].setText(theTrans.forSnapShot);
					table[3].setText(theTrans.forSnapShot);
					tt.start();
				}else{
					operations[5].setEnabled(false);
		...
		refreshButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				...
				if(!input.equals("")){
					...
					textArea[0].setText("Nothing to RESET!");
				}
			}
		});
